...
function Phone13() {
  ...
  const addToCart = () => {
    ...
    SetCartData((prevCartData) => [...prevCartData, newItem]);
       ...
       const fetchData = () => {
        axios.get('https://troubled-ray-fashion.cyclic.cloud/iphone13/6514542aced596e1193ac753')
          .then((res) => {
...
// .......................................HANDLE PHONE CLICK BUTTON (IPHONE 14 OR IPHONE13 PLUS)...........................................
  ...
  From ₹50915 or ₹2040/month for 24 months
  </Text>
</Box>
...
<Button height="80px" width= "100%" mt = "10"  border="2px  black"  _focus={{ boxShadow: "0 0 5px 0 rgba(0, 0, 0, 0.5)" }}  onClick={handlePhone13} >       
                        ...
                        <Box textAlign="left" >
                                <Text fontSize="xl" color="black" fontWeight={600} mt="1" ml="0" textAlign="left">iPhone 13</Text>
...
<Button height="80px" width= "100%" mt = "8px"  border="2px  black"  _focus={{ boxShadow: "0 0 5px 0 rgba(0, 0, 0, 0.5)" }} onClick={handlePhone13}   >       
                        <Flex justifyContent="space-around" alignItems="center" width="100%">
                        <Box textAlign="left" >
                                <Text fontSize="xl" color="black" fontWeight={600} mt="1" ml="0" textAlign="left">iPhone 13 Plus</Text>
                                <Text fontSize="l" color="gray.600" fontWeight={400} mt="1" ml="0" textAlign="left">6.7-inch display</Text>
                        </Box>
                         <Box>
                         <Text fontSize="sm" color="gray.800" fontWeight={400} textAlign="right" mt="-5">₹2386/mo. for 24 months</Text>
  ...
  <ModalContent>
    ...
    <ModalBody>
      <Flex flexWrap="wrap" justifyContent="center">
        ...
        >
          <Image
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQE7oIv8JKSXQzkT45Uqyw8BASYyhdzUSfIjLQMeISDWt4D9k8PK9xpHNC72Kg5DrHoxAI&usqp=CAU"
            alt="iPhone 13"
            height="auto"
            width="100%"
            maxH="300px"
      ...
      <Box mt="4" p="4">
        <Text fontSize="xl" color="black" mt="3" textAlign="left">
          iPhone 13 and iPhone 13 Plus share the same fantastic innovations, like a Pro-level camera, a durable design with Ceramic Shield, vital safety features, and our lightning-fast A15 Bionic chip with 5-core GPU.
        </Text>
        <Text fontSize="2xl" color="black" fontWeight="bold" mt="3" textAlign="left">
          Here are the key differences:
        </Text>
        <Text fontSize="xl" color="black" mt="3" textAlign="left">
          iPhone 13 has a 6.1-inch display¹ and gets up to 20 hours video playback.
          iPhone 13 Plus has a 6.7-inch display¹ and gets up to 26 hours video playback.
        </Text>
      </Box>
    </ModalBody>
    <ModalFooter>
...
<Button height="80px" width= "100%" mt = "20px"  border="2px  black"  _focus={{ boxShadow: "0 0 5px 0 rgba(0, 0, 0, 0.5)"}} onClick={()=>{setGb("128GB"); setPrice(65864)}}    >       
                        <Flex justifyContent="space-around" alignItems="center" width="100%">
                        <Box textAlign="left" >
                                <Text fontSize="l" color="black" fontWeight={600} mt="1" ml="0" textAlign="left">128GB</Text>
                                <Text fontSize="l" color="black" fontWeight={600} mt="1" ml="0" textAlign="left">From ₹65864 or ₹3242/mo.per for 24 mo. </Text>
                        </Box>
                     </Flex>  
</Button>
...
<Button height="80px" width= "100%" mt = "20px"  border="2px  black"  _focus={{ boxShadow: "0 0 5px 0 rgba(0, 0, 0, 0.5)" }}   onClick={() => {
  ...
  setPrice(76415);
                        ...
                        <Box textAlign="left" >
                                ...
                                <Text fontSize="l" color="black" fontWeight={600} mt="1" ml="0" textAlign="left">From ₹76415 or ₹3415/mo.per for 24 mo.</Text>
                        </Box>
                     </Flex>  
</Button>
...
<Button height="80px" width= "100%" mt = "20px"  border="2px  black"  _focus={{ boxShadow: "0 0 5px 0 rgba(0, 0, 0, 0.5)" }}   onClick={()=>{
 ...
 setPrice(93415)}} >       
                        ...
                        <Box textAlign="left" >
                                ...
                                <Text fontSize="l" color="black" fontWeight={600} mt="1" ml="0" textAlign="left">From ₹93415 or ₹5925/mo.per  for 24 mo.</Text>
                        </Box>
                     </Flex>  
</Button>
...
<Box mt = "10">
                 <Text fontSize="sm"  mr="0" mt="8" ml = "1">As part of our efforts to reach carbon neutrality by 2030, iPhone 13 and iPhone 1 Plus do not include a power adapter or EarPods. 
...
{/* ........................QUESTION AND ANSWER................... */}
              ...
              <Accordion defaultIndex={[0]} allowMultiple>
                 ...
                 <AccordionItem>
                     ...
                     A discount of up to ₹3000/month for internet service (or a discount up to ₹7500/month for households on qualifying Tribal lands); and. A one-time discount of up to ₹10000 for a laptop, desktop computer, or tablet purchased through a participating provider.
