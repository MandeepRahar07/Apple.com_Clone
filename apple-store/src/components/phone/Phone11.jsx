...
function Phone11() {
    ...
    const images = [
        "https://images.frandroid.com/wp-content/uploads/2019/09/photo.png",
        "https://vtv1.mediacdn.vn/2019/10/22/photo-1-1571718854833150823057.png",
        "https://images.unsplash.com/photo-1600541519467-937869997e34?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8aXBob25lJTIwMTF8ZW58MHx8MHx8fDA%3D&w=1000&q=80",
        "https://m.media-amazon.com/images/I/61VaNC4BGHL.jpg",
        "https://i.ytimg.com/vi/M3yIViqkmME/hqdefault.jpg",
...
// .......................................HANDLE PHONE CLICK BUTTON (IPHONE 14 OR IPHONE11 PLUS)...........................................
      const handlePhone11=()=>{
       setButtonClick((prevButtonClick) => !prevButtonClick)
       setColor(data.iPhone11)
       setGb("")
      }
...
{/* .......................................................................................... */}
<Box ml="10px" mt="8px">
<Button height="80px" width= "100%" mt = "10"  border="2px  black"  _focus={{ boxShadow: "0 0 5px 0 rgba(0, 0, 0, 0.5)" }}  onClick={handlePhone11} >       
                        <Flex justifyContent="space-around" alignItems="center" width="100%">
                        <Box textAlign="left" >
                                <Text fontSize="xl" color="black" fontWeight={600} mt="1" ml="0" textAlign="left">iPhone 11</Text>
...
<Button height="80px" width= "100%" mt = "8px"  border="2px  black"  _focus={{ boxShadow: "0 0 5px 0 rgba(0, 0, 0, 0.5)" }} onClick={handlePhone11}   >       
                        <Flex justifyContent="space-around" alignItems="center" width="100%">
                        <Box textAlign="left" >
                                <Text fontSize="xl" color="black" fontWeight={600} mt="1" ml="0" textAlign="left">iPhone 11 Pro</Text>
  ...
  <ModalContent>
    ...
    <ModalBody>
      <Flex flexWrap="wrap" justifyContent="center">
        ...
        >
          <Image
            src="https://d27ea4kkb8flj9.cloudfront.net/196691_1_L.jpg"
            alt="iPhone 11"
            height="auto"
            width="100%"
            maxH="300px"
        ...
        >
          <Image
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTu4xlzfu5IHtSQ-NrhnQ7ibRjHULTrMBmZoZ5jc-wMVyshvJ91rjHkAmyC0JsL1fWpSOw&usqp=CAU"
            alt="iPhone 11 pro"
            height="auto"
            width="100%"
            maxH="300px"
      ...
      <Box mt="4" p="4">
        <Text fontSize="xl" color="black" mt="3" textAlign="left">
          iPhone 11 and iPhone 11 Pro share the same fantastic innovations, like a Pro-level camera, a durable design with Ceramic Shield, vital safety features, and our lightning-fast A15 Bionic chip with 5-core GPU.
        </Text>
        <Text fontSize="2xl" color="black" fontWeight="bold" mt="3" textAlign="left">
          Here are the key differences:
        </Text>
        <Text fontSize="xl" color="black" mt="3" textAlign="left">
          iPhone 11 has a 6.1-inch display¹ and gets up to 20 hours video playback.
          iPhone 11 Pro has a 6.7-inch display¹ and gets up to 26 hours video playback.
        </Text>
      </Box>
    </ModalBody>
    <ModalFooter>
...
<Flex flexWrap="wrap" justifyContent="center">
  <Button onClick={() => setColor(data.iPhone11Blue)}>
    <Image
      borderRadius="full"
      boxSize={['40px', '50px']}
  ...
  <Button onClick={() => setColor(data.iPhone11Purple)}>
    <Image
      borderRadius="full"
      boxSize={['40px', '50px']}
  ...
  <Button onClick={() => setColor(data.iPhone11Yellow)}>
    <Image
      borderRadius="full"
      boxSize={['40px', '50px']}
  ...
  <Button onClick={() => setColor(data.iPhone11Black)}>
    <Image
      borderRadius="full"
      boxSize={['40px', '50px']}
  ...
  <Button onClick={() => setColor(data.iPhone11White)}>
    <Image
      borderRadius="full"
      boxSize={['40px', '50px']}
...
<Button height="80px" width= "100%" mt = "20px"  border="2px  black"  _focus={{ boxShadow: "0 0 5px 0 rgba(0, 0, 0, 0.5)"}} onClick={()=>{setGb("128GB"); setPrice(40999)}}     >       
                        <Flex justifyContent="space-around" alignItems="center" width="100%">
                        <Box textAlign="left" >
                                <Text fontSize="l" color="black" fontWeight={600} mt="1" ml="0" textAlign="left">128GB</Text>
                                <Text fontSize="l" color="black" fontWeight={600} mt="1" ml="0" textAlign="left">From ₹40999 or $1699/mo.per for 24 mo. </Text>
                        </Box>
                     </Flex>  
</Button>
...
<Button height="80px" width= "100%" mt = "20px"  border="2px  black"  _focus={{ boxShadow: "0 0 5px 0 rgba(0, 0, 0, 0.5)" }}   onClick={() => {
  ...
  setPrice(40999);
                        ...
                        <Box textAlign="left" >
                                ...
                                <Text fontSize="l" color="black" fontWeight={600} mt="1" ml="0" textAlign="left">From ₹50999 or $37.45/mo.per for 24 mo.</Text>
                        </Box>
                     </Flex>  
</Button>
...
<Button height="80px" width= "100%" mt = "20px"  border="2px  black"  _focus={{ boxShadow: "0 0 5px 0 rgba(0, 0, 0, 0.5)" }}   onClick={()=>{
 ...
 setPrice(79599)}}>       
                        ...
                        <Box textAlign="left" >
                                ...
                                <Text fontSize="l" color="black" fontWeight={600} mt="1" ml="0" textAlign="left">From ₹79599 or $45.79/mo.per  for 24 mo.</Text>
                        </Box>
                     </Flex>  
</Button>
...
<Box mt = "10">
                 <Text fontSize="sm"  mr="0" mt="8" ml = "1">As part of our efforts to reach carbon neutrality by 2030, iPhone 11 and iPhone 11 Pro do not include a power adapter or EarPods. 
